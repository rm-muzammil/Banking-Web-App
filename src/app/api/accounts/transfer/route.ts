...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        // Find sender user with populated account
        const sender = await User.findById(decoded.id)
            .populate<{ account: IAccount }>("account")
            .exec();
        ...
        // Create transaction record for sender (money sent)
        ...
        // Create transaction record for receiver (money received)
        const receiverTransaction = new Transaction({
            ...
            description: `Received from account ${sender.account.accountNumber}`,
        });
